...
public class IT24103629Lab4Q2 {
    public static void main(String[] args) {
        ...
        examPercentage = mark.nextDouble();
        ...
        labPercentage = mark.nextDouble();
        if (labPercentage < 0 || labPercentage > 100) {
            System.out.println("Invalid input for the percentage given for the lab submission. Terminating program.");
            return; 
        }
